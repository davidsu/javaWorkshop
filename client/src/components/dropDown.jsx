        ...
        return(
            <div className="col-sm-12" style={{padding:0}}>
                ...
                <div className="col-sm-8">
                    <select className={'form-control ' + this.props.className} {...this.props.disabled} value={this.props.value} onChange={this.props.onChange} ref={(select) => this.select = select}>
